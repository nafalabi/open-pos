...
interface MultiSelectProps {
  ...
  creatable?: boolean;
  onCreateNew?: (value: string) => Promise<Option | undefined | void>;
  /** Props of `Command` */
...
const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    const CreatableItem = () => {
      ...
      if (inputValue.length === 0) return undefined;
    ...
    return (
      ...
      >
        <div
          className={cn(
            "min-h-10 rounded-md border border-input text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 relative",
            {
          ...
          <div className="flex flex-wrap gap-1">
            ...
            {(isLoading || isCreating) && (
              <div className="absolute top-2 right-2">
                <Loader2Icon className="h-5 w-5 animate-spin border-foreground" />
              </div>
            )}
          </div>
        </div>
